...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-ah-navy min-h-screen text-ah-white pt-40 pb-20 relative overflow-hidden" }, _attrs))} data-v-d344cc3d><div class="fixed inset-0 z-0 transition-all duration-1000 ease-in-out opacity-20 grayscale pointer-events-none" data-v-d344cc3d>`);
      _push(ssrRenderComponent(_component_baseImage, {
        source: unref(activeBg),
        style: `w-full h-full object-cover scale-110`,
        alt: "Background Preview"
      }, null, _parent));
      _push(`<div class="absolute inset-0 bg-linear-to-b from-ah-navy via-transparent to-ah-navy" data-v-d344cc3d></div></div><div class="max-w-7xl mx-auto px-6 md:px-12 relative z-10" data-v-d344cc3d><header class="mb-24" data-v-d344cc3d><span class="text-ah-lime font-mono text-xs tracking-[0.3em] uppercase mb-4 block" data-v-d344cc3d>Archive</span>`);
      _push(ssrRenderComponent(_component_baseHeader, { text: "Projects" }, null, _parent));
      _push(`</header><div class="flex flex-col border-t border-white/10" data-v-d344cc3d><!--[-->`);
      ssrRenderList(projects, (project) => {
        _push(`<div class="group border-b border-white/10 py-12 cursor-pointer transition-colors hover:bg-white/5 px-4" data-v-d344cc3d>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          to: project.href
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="grid grid-cols-1 md:grid-cols-12 items-center gap-8" data-v-d344cc3d${_scopeId}><div class="md:col-span-1 font-mono text-ah-grey/30 group-hover:text-ah-lime transition-colors" data-v-d344cc3d${_scopeId}>${ssrInterpolate(project.id)}</div><div class="md:col-span-5" data-v-d344cc3d${_scopeId}><h3 class="text-4xl md:text-6xl font-black uppercase italic tracking-tighter group-hover:translate-x-4 transition-transform duration-500" data-v-d344cc3d${_scopeId}>${ssrInterpolate(project.title)}</h3></div></div>`);
            } else {
              return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d344cc3d"]]);

export { index as default };
//# sourceMappingURL=index-BiRYIu7h.mjs.map
