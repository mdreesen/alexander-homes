                              ...
                              if (_push5) {
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$7, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : __props.orientation === "vertical" && __props.collapsed && (!!props.tooltip || !!item.tooltip) || __props.orientation === "horizontal" && !!item.tooltip ? (openBlock(), createBlock(_sfc_main$5, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, props.labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UHeader, mergeProps({
        mode: "slideover",
        class: "fixed w-full border-none"
      }, _attrs), {
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="flex flex-col leading-none"${_scopeId2}><span class="font-black uppercase tracking-tighter text-lg md:text-2xl text-white"${_scopeId2}>Alexander</span><span class="font-bold uppercase tracking-[0.3em] text-[10px] text-ah-lime"${_scopeId2}>Homes &amp; Painting</span></div>`);
                } else {
                  return [
                    ...
                    createVNode("div", { class: "flex flex-col leading-none" }, [
                      createVNode("span", { class: "font-black uppercase tracking-tighter text-lg md:text-2xl text-white" }, "Alexander"),
                      createVNode("span", { class: "font-bold uppercase tracking-[0.3em] text-[10px] text-ah-lime" }, "Homes & Painting")
                    ])
                  ];
                }
              }),
...
const __nuxt_component_0 = Object.assign(_sfc_main$3, { __name: "BaseNavigation" });
const theme = {
  "slots": {
    "root": "",
    "top": "py-8 lg:py-12",
