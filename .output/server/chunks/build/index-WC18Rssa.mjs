  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(images, (_, index2) => {
        ...
        _push(`<div class="absolute inset-0 bg-linear-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8" data-v-c99e4588><span class="font-mono text-xs uppercase tracking-widest mb-2" data-v-c99e4588>Alexander Homes Verified</span></div> 1/div&gt; <div class="p-5 flex justify-between items-center bg-zinc-900 border-t border-zinc-800" data-v-c99e4588><div class="w-8 h-0.5 bg-zinc-700 group-hover:w-16 group-hover:bg-white transition-all duration-300" data-v-c99e4588></div></div></div></div>`);
      });
      _push(`<!--]--></div></section>`);
    };
  }
