...
const _routes = [
  ...
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CBlBXukJ.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DVzil03b.mjs')
  },
  {
    name: "projects",
    path: "/projects",
