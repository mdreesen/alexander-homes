...
<template>
  <section class="py-24 px-6 md:px-12 border-t border-zinc-800">
    ...
    <header class="mb-20">
      ...
      <baseDescription
        text="From residential foundations to complex commercial scale, Alexander Homes defines endurance." />
    </header>
    ...
    <div class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-8 space-y-8">
      <div v-for="_, index in images" :key="index"
        ...
        <div class="aspect-square">
          <baseImage :source="`/images/projects/process/process_${index + 1}.webp`"
